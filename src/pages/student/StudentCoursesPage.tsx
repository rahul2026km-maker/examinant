        ...
        <div className="max-w-7xl mx-auto space-y-8 pb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-sm">
                <div>
                    ...
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Enrolled Batches</h1>
            ...
            {isLoading ? (
                ...
                <div className="text-center py-20 bg-white rounded-3xl border border-slate-100 space-y-4">
                    ...
                    <h3 className="text-xl font-extrabold text-slate-800">You haven't enrolled in any batches yet.</h3>
                    <p className="text-slate-500 text-sm max-w-md mx-auto">Explore expert video batches and start building your exam preparation today.</p>
                    <button
                        onClick={() => navigate('/courses')}
